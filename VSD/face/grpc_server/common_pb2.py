...
_NONMOTORVEHICLETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='TRANSPORTATION_BICYCLE', index=0, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TRANSPORTATION_VEHICLE2', index=1, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TRANSPORTATION_VEHICLE3', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TRANSPORTATION_ROOF', index=3, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TRANSPORTATION_SEAL', index=4, number=4,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_RECFACEPOSE = _descriptor.Descriptor(
  name='RecFacePose',
  full_name='dg.model.RecFacePose',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='Type', full_name='dg.model.RecFacePose.Type', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='Angles', full_name='dg.model.RecFacePose.Angles', index=1,
...
_RECFACE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='Pose', full_name='dg.model.RecFace.Pose', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='BlurScore', full_name='dg.model.RecFace.BlurScore', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='AlignScore', full_name='dg.model.RecFace.AlignScore', index=6,
      number=7, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RECFACE.fields_by_name['Pose'].message_type = _RECFACEPOSE
...
_RECNONMOTORVEHICLE.fields_by_name['NMVehicleType'].enum_type = _NONMOTORVEHICLETYPE
...
DESCRIPTOR.message_types_by_name['RecFacePose'] = _RECFACEPOSE
...
RecFacePose = _reflection.GeneratedProtocolMessageType('RecFacePose', (_message.Message,), dict(
  DESCRIPTOR = _RECFACEPOSE,
  __module__ = 'common_pb2'
  # @@protoc_insertion_point(class_scope:dg.model.RecFacePose)
  ))
_sym_db.RegisterMessage(RecFacePose)
