...
#imageName = "http://192.168.2.17/dgtestdata/dog_test/vehicle_danger_yellow_car.jpg"
imageName = "http://192.168.2.119:5004/201503181011410001404.jpg"
#imageName = "http://192.168.2.17/dgtestdata/dog_test/nonvehicle.jpg"
#imageName = "http://192.168.2.17/dgtestdata/dog_test/pedestrian.jpg"

conf = dict(
        matrixIp = "192.168.2.164",
        matrixPort = "6501",
...
class AnalyzeMatrix():
    ...
    def postRequest(self,img_list):
        ...
        source = {"Context": {"SessionId": str(SESSION_ID),                                                                                      
                              "Functions": [101,102,103,104,105,106,107,108,109,110,300,301,400,401],        
                              "Type":1                                                                                                   
                             }                                                                                                            
                  }
        if conf["mode"] == 0:
    ...
    def singleReq(self,img_list):
        for img in img_list:
            ...
            if conf["uriType"] == 2:
                query_dict = {'URI': img}
            post_img = {"Data": query_dict,"UserObject": [{"Type":2}]}
    ...
    def batchReq(self,img_list):
        ...
        for i,img in enumerate(img_list):
            ...
            if conf["uriType"] == 2:
                query_dict = {'URI': img}
            post_img.append({"Data": query_dict,"UserObject": [{"Type":2}]})
    ...
    def analyzeVehicle(self,datadict,im):
        ...
        for vehicle in datadict["Vehicles"]:
            ...
            if "Attributes" in vehicle:
                ...
                #attribute_list = ["danger_car","yellow_car"]
                for attribute in attributes:
                    #for i,item in enumerate(attribute_list):
                    if attribute["AttributeId"] == 58 and attribute["ValueId"] == 1:
                        vehicle_dict["danger_car"] = attribute["ValueString"]
                    if attribute["AttributeId"] == 58 and attribute["ValueId"] == 2:
                        vehicle_dict["yellow_car"] = attribute["ValueString"]
            ...
            v_lst = ["cutboard","brand","subrand","modelyear","cartype","pose","color","plates",
                   ...
                   "driver_belt","driver_phone","codriver_belt","codriver_phone","danger_car","yellow_car"]
            data_dict = {}
            for item in v_lst:                                                                                                  
...
def info():
    print "机动车:cutboard;主品牌;子品牌;年款;车型;车姿态;车身颜色;车牌号&车牌颜色;年检标数量;摆件数量;挂坠数量;纸巾盒数量;左遮阳板数量;右遮阳板数量;主驾安全带;主驾打电话;副驾安全带;副驾打电话;危险品车;黄标车\n",\
