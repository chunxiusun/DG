...
class AnalyzeMatrix():
    ...
    def postRequest(self,img_list):
        ...
        source = {"Context": {"SessionId": str(SESSION_ID),                                                                                      
                              "Functions": [100,101,102,103,104,105,106,107,108,109,110,200,201,202,203,204,205,300,301,400,401,402],        
                              "Type":1                                                                                                   
                             }                                                                                                            
                  }
        if conf["mode"] == 0:
    ...
    def singleReq(self,img_list):
        for img in img_list:
            #img = "http://192.168.2.16:6001/01/519020403902-20150102132334-5-1.jpg"
            #img = "http://192.168.2.17/dgtestdata/PictureData/nomotor/%E4%B8%98%E6%B5%B7%E5%A4%A7%E9%81%93-%E8%8B%8D%E8%A5%BF%E6%9D%91%E5%8D%A1%E5%8F%A3/69411834496552337344618974_%E5%8C%97%E5%90%91%E5%8D%97%E8%BD%A6%E9%81%934.2017-12-17%20003156.%E7%B2%A4A17257.M21.J.01.2.31.jpg"
                    ...
                    if "Attributes" in passenger:
                        for attribute in passenger["Attributes"]:
                            ...
                            for i,item in enumerate(lst):
                                if attribute_id == item:
                                    nonMotorvehicle_dict[a_lst[i]] = attribute["ValueString"]
            if "Plate" in nonmotorvehicle:
                nMVehicle_plate_text = nonmotorvehicle["Plate"]["PlateText"]
                nMVehicle_plate_color = nonmotorvehicle["Plate"]["Color"]["ColorName"]
                nonMotorvehicle_dict["nMVehicle_plate"] = "%s&%s"%(nMVehicle_plate_text,nMVehicle_plate_color)
            self.fd.write("%s;NonMotorVehicle;"%im)
            n_lst = ["cutboard","nMVehicle_type","nMVehicle_gesture","nMVehicle_color","nMVehicle_plate","gender","nation",                    
...
def usage():
    print "Usage: \n",\
          ...
          "--outputfile (result file,defult:result.txt)\n",\
...
def info():
    print "机动车:cutboard;主品牌;子品牌;年款;车型;车姿态;车身颜色;车牌号&车牌颜色;年检标数量;摆件数量;挂坠数量;纸巾盒数量;左遮阳板数量;右遮阳板数量;主驾安全带;主驾打电话;副驾安全带;副驾打电话\n",\
          ...
          "非机动车:cutboard;车辆类型;车辆角度;车身颜色;非机动车车牌;人员性别;人员民族;人员头部特征;人员上身颜色;人员上身样式;包款式\n"
