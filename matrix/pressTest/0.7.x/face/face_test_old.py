...
conf = dict(
        ...
        thread_num = 30,                 # thread num
        photo_path = "/home/dell/matrix/face_test/face-img/",           # image path
        ...
        uri_type = 0,                   # 0 means local path, 1 means http path, 2 means encode to base64
