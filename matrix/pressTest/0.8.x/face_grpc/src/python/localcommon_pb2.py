...
_RECOGNIZEFUNCTIONS = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RECFUNC_FACE_DETECT', index=10, number=200,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RECFUNC_FACE_ALIGNMENT', index=11, number=201,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RECFUNC_FACE_QUALITY_LV1', index=12, number=202,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RECFUNC_FACE_QUALITY_LV2', index=13, number=203,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RECFUNC_FACE_FEATURE', index=14, number=204,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RECFUNC_FACE_ATTRIBUTE', index=15, number=205,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RECFUNC_PEDESTRIAN_ATTRIBUTE', index=16, number=300,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RECFUNC_NON_MOTOR_ATTRIBUTE', index=17, number=400,
      options=None,
      type=None),
  ],
  containing_type=None,
