...
conf = dict(
        ...
        endpoints = dict(
            single = "http://192.168.2.164:5501/rec/image",
            batch = "http://192.168.2.164:5501/rec/image" + "/batch",
        ),
        batchNum = 8,
        functions = [100,101,102,103,104,105,106,107,108,109,110,300,301,400,401],
